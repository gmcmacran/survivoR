...
Survival is much worse for patients with complications. Note the two survival curves have the exact same curvature. This is due to the proportional hazard assumption of the Cox model. 
```{r}
#| echo: false
...
Controlling for other variables, complications are associated with worse survival.
